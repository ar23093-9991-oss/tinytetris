...
)+y][N(r,(i*2)+2)+x]=v;return 0;}I F(){for(I c=0;c<20;c++){for(I k=0;k<2;k++){move(1+c*2+k,1);for(auto &z:a[c]){
z&&attron(262176|z<<8);printw("    ");attroff(262176|z<<8);}}move(41,1);printw("S"
"core: %d",s);refresh();return 0;}I P(){y=g=0;p=rand()%7;r=h=rand()%4;x=f=rand()%(10-N(r,
...
][0],40);memset(&a[0][0],0,10);s++;}return 0;}I C(I x,I y,I r){if(y+N(r,18)>19)return 1;S
